...
def create_user(port):
    ...
    admin_client.register(
        name='Bobby Brown', 
        email='bobby@openmined.org', 
        password='bobby',
        password_verify= 'bobby'
    )
    print("External researcher 'Bobby' has been created!")
...
def code_submission(port):
    ...
    print("External Researcher Bobby has logged in! (1/3)")
    ...
    project = ds_client.create_project(
        ...
        user_email_address= "bobby@openmined.org"
    )
    print("Bobby has created a project, 'Occupations & Life Span Relationship'! (2/3)")

    # Create Syft Functions
    print("Bobby is writing code for his project...")
    ...
    print("Bobby has submitted his code for review! (3/3)")
